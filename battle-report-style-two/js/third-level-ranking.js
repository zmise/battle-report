$(function () {
  ...
  requestData = {
    data: [7972, 3860, 3527, 2573, 2403, 1768, 151, 103, 91, 83, 41, 34, 27],//value值
    titleData: ['深圳中', '上海', '深圳西', '深圳东', '杭州', '珠海', '香港', '中山', '佛山', '苏州', '广州', '南京', '北京'], //y轴标题
    textColor: '#abaaa6', //y轴字体颜色
    barColor: '#fff4cc', //柱形颜色
    barTextColor1: '#2d2a16', //value值的颜色
    specialIndex: 0,
    specialColor: 'skyblue',
  }
  renderCompanyColumnBarChart('columnBar1', requestData);
});
